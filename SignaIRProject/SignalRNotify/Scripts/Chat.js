...
; !function (win, undefined) {
    ...
    chatCore.view = (function () {
        var ChatCoreNode = chatCore.ChatCoreNode = $('<div id="ChatCoremm" class="ChatCore_main">'
                ...
                + '  <div class="ChatCore_tabs" id="ChatCore_tabs"><span class="ChatCore_tabfriend" title="好友"><i></i></span><span class="ChatCore_tabgroup" title="群组"><i></i></span><span class="ChatCore_latechat"  title="最近聊天" style="display:none;"><i></i></span></div>'
                ...
                + '<li class="ChatCore_online" id="ChatCore_online">'
                    ...
                    + '</div>'
                + '</li>'
                + '<li class="ChatCore_mymsg" id="ChatCore_mymsg" title="聊天室"><i></i><a href="' + config.roomUrl + '" target="rightFrame"></a></li>'
